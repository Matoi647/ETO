# bash run_eto_test.sh alfworld exp01 "/data3/hwz/" ./exp/exp01/
...
python -m torch.distributed.run --nproc_per_node=${node_num} --master_port=20001 fastchat/train/train_lora.py \
